...
def main():
    ...
    parser.add_argument("--cluster-config", default="cluster-config.json", help="Path to the cluster config JSON file")
    parser.add_argument("--provisioning-parameters", default='src/lcc-data/provisioning_parameters.json',
                        help="Path to the provisioning parameters JSON file")
